...
from AxiomMusic.utils.database import add_off, add_on
...
async def logger(client, message, _):
    ...
    await message.reply_text("<blockquote expandable><b>✧ Please check given file to cookies file choosing logs... <blockquote expandable><b>✧")
