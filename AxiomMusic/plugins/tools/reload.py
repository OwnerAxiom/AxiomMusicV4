...
from AxiomMusic.utils.database import get_assistant, get_authuser_names, get_cmode
from AxiomMusic.utils.decorators import ActualAdminCB, AdminActual, language
from AxiomMusic.utils.formatters import alpha_to_int, get_readable_time
...
async def close_menu(_, query: CallbackQuery):
    try:
        ...
        ufff = await query.message.reply_text(
            f"<b>✧ ᴄʟᴏꜱᴇ ʙʏ : {query.from_user.mention} </b>"
        )
