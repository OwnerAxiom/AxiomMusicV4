...
from AxiomMusic.utils.formatters import convert_bytes
from AxiomMusic.utils.inline.song import song_markup

mycookies = "AxiomMusic/cookies.txt"
...
async def song_download_cb(client, CallbackQuery, _):
    ...
    try:
        ...
        await CallbackQuery.answer("<blockquote expandable><b>✧ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ...</b></blockquote>")
    ...
    with yt_dlp.YoutubeDL({"cookiefile": "AxiomMusic/cookies.txt", "quiet": True}) as ytdl:
