...
from AxiomMusic.utils.database import add_sudo, remove_sudo
from AxiomMusic.utils.decorators.language import language
from AxiomMusic.utils.extraction import extract_user
from AxiomMusic.utils.inline import close_markup
from config import BANNED_USERS, OWNER_ID


@app.on_message(filters.command(["hoii", "addsudo"]) & filters.user(OWNER_ID))
@language
...
@app.on_message(filters.command(["hurr", "rmsudo"]) & filters.user(OWNER_ID))
@language
