...
async def unauthorised(
    ...
    if bot_lacking_permission:
        text = (
            "<blockquote expandable><b>✧ I don't have the required permission to perform this action. </b></blockquote>"
            + f"\n<blockquote expandable><b>✧ Permission: {permission} </b></blockquote>"
        )
    else:
        text = (
            "<blockquote expandable><b>✧ You don't have the required permission to perform this action. </b></blockquote>"
            + f"\n<blockquote expandable><b>✧ Permission: {permission} </b></blockquote>"
        )
    try:
